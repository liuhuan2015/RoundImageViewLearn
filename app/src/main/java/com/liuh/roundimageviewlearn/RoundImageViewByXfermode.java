package com.liuh.roundimageviewlearn;
...
/**
 * Created by huan on 2017/11/17 10:12.
 */
...
public class RoundImageViewByXfermode extends ImageView {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (null == bitmap || bitmap.isRecycled()) {
            ...
            if (drawable != null) {
                ...
                //因为设置的src的宽高比例可能和ImageView的宽高比例不同，这里我们不希望图片失真
                if (type == TYPE_ROUND_CORNER) {
                ...
                drawable.setBounds(0, 0, (int)
                        scale * dWidth, (int) scale * dHeight);
    ...
    //因为我们缓存了，所以当调用invalidate时，将缓存清除
    @Override
